//
//  Api+ManagerAdvanceRequests.swift
//  HollyDesk
//
...
extension ManagerAdvanceRequestsViewController{
    func getRequestsData(loading: Bool) {
        DispatchQueue.main.async {
            ...
            let manager = Manager()
            manager.perform(RequestsModel.self, serviceName: .managerInAdvanceRequest, method: .get,getWithParams: true, authenticationEnabled: true , parameters: param) {[weak self] (result) in

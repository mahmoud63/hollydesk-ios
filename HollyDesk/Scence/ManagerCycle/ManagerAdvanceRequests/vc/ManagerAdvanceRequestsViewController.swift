//
//  ManagerAdvanceRequestsViewController.swift
//  HollyDesk
//
...
class ManagerAdvanceRequestsViewController: UIViewController {
    ...
    //MARK:- setupTableView
    func setupTableView(){
        tableView.register(ManagerAdvanceRequestsTableViewCell.nib, forCellReuseIdentifier: "ManagerAdvanceRequestsTableViewCell")

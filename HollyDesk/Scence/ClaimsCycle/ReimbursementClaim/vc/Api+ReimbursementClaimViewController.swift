//
//  Api+ReimbursementClaimViewController.swift
//  HollyDesk
//
...
extension ReimbursementClaimViewController{
    func getRequestsData(loading: Bool) {
        DispatchQueue.main.async {
            ...
            let manager = Manager()
            manager.perform(RequestsModel.self, serviceName: .requests, method: .get,getWithParams: true , authenticationEnabled: true , parameters: parm) {[weak self] (result) in
